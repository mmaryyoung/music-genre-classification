...
source_path = "/root/data/genres/"
dest_path = "/root/data/tzanetakis/ver9.0/"
...
x_holdout = np.empty([num_genres*10*samples_per_song, source_rate*seconds_per_sample])
y_holdout = np.empty([num_genres*10*samples_per_song, num_genres])


def parseAudio(genreIndex, songIndex, fName):
 	if songIndex > 45: # for memory error
 		return
